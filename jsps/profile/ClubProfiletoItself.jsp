  ...
  <body>
   ...
   <div id = 'See Tournaments' style="margin-top:20px; margin-left:460px; position:absolute "> <a href="file:///home/rishirajsingh/3.1/dbms/project/jsps/signupAndLogin/login.jsp">Logout</a>
	...
	<tr>
	  ...
	  <td width="350"><div align="left"><h2>Longton Tennis Club</h1></div></td>
...
<tr>
  <td width="100" colspan="2"><div align="left">About It : The club has 375 full members, about 100 temporary playing members, and a number of honorary members, including past Wimbledon singles champions and people who have rendered distinguished service to the game.The patron of the club is Queen Elizabeth II, and the President is The Duke of Ken</div></td>
</tr>
</table>
...
<table border="0" style="margin-top:350px; margin-left:0px; position:absolute">
  ...
  <tr>
    <td width="200" colspan="2" ><div align="left">&bull; Relayering or courts at Dadar Gymkhana</div></td>
  </tr>
  <tr>
    <td width="200" colspan="2" ><div align="left">&bull; New Floodlights installed at Wimbeldon</div></td>
  </tr>
  <tr>
    <td width="200" colspan="2"><div align="left">&bull; Nadal wins the French Open</div></td>
  </tr>
...
<div id = 'Tournament' style="margin-top:530px; margin-left:100px; position:absolute"> <a href="../tournament/tournament.jsp">View Tournaments Page</a>
</div>
