<html>
  ...
  <h3 align="center">Sign Up as a club</h3><hr>
  
  <body>
  <table width="500" border="0" cellspacing="0" cellpading="0">
    <form action="clubextrainfo.jsp">
   <tr>
  ...
  <tr>
  <td width="600"><div align="right"><br><input type="Submit" name="CLUBSIGNUP" value = "Proceed"></td>
  </tr>
  </form>
  </table>
  </body>
